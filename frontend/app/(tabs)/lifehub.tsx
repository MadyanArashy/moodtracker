          ...
          <View style={tw`rounded-md`}>
            ...
            <View style={tw`flex-col gap-1`}>
              <AnimatedButton onPress={isEditing ? handleEdit : handleAddTask} style={tw`align-middle justify-center`} disabled={!valid} animationType={'scale'}>
                <ThemedText
                  style={[
                    ...
                    {backgroundColor: valid ? colors.tint : colors.highlight, color: valid ? colors.text : colors.disabledText, backgroundOpacity: valid ? '100' : '40'}
                  ]}>
              ...
              <AnimatedButton
                ...
                onPress={() => cancelEdit()}
                style={{ backgroundColor: colors.highlight, borderColor: colors.highlight, padding: 4, width: 100, borderRadius: 4 }}
                disabled={!name && !category}
              >
                <ThemedText style={[tw`text-center`, {color: (!name && !category) ? colors.disabledText : colors.text}]}>
